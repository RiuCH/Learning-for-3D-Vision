...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        render_voxel_360(voxels_src, output_file="output/Optimized_Voxel_Grid.gif", dist=3)
        render_voxel_360(voxels_tgt, output_file="output/GT_Voxel_Grid.gif", dist=3)
        concat_media_horizontally(["output/Optimized_Voxel_Grid.gif", "output/GT_Voxel_Grid.gif"], output_path="output/Voxel_Comparison.gif", 
                                  captions=["Optimized Voxel Grid", "Ground Truth Voxel Grid"])
        ...
        render_pc_360(pointclouds_src[0].detach(), output_file="output/Optimized_PointCloud.gif", dist=1)
        render_pc_360(pointclouds_tgt[0].detach(), output_file="output/GT_PointCloud.gif", dist=1)
        concat_media_horizontally(["output/Optimized_PointCloud.gif", "output/GT_PointCloud.gif"], output_path="output/Point_Comparison.gif", 
                                  captions=["Optimized Point Cloud", "Ground Truth Point Cloud"])        
        ...
        render_mesh_360(mesh_src.detach(), output_file="output/Optimized_Mesh.gif", dist=1)
        render_mesh_360(mesh_tgt.detach(), output_file="output/GT_Mesh.gif", dist=1)
        concat_media_horizontally(["output/Optimized_Mesh.gif", "output/GT_Mesh.gif"], output_path="output/Mesh_Comparison.gif", 
                                  captions=["Optimized Mesh", "Ground Truth Mesh"])    
